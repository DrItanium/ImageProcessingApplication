...
using TheoreticalIndustries.Libraries.Imaging;
using TheoreticalIndustries.Libraries.Filter;
using TheoreticalIndustries.Frameworks.Plugin;
using TheoreticalIndustries.Libraries.LexicalAnalysis;
using TheoreticalIndustries.Libraries.Extensions;
using TheoreticalIndustries.Libraries.Parsing;
using TheoreticalIndustries.Libraries.Starlight;
using TheoreticalIndustries.Libraries.Tycho;
using msg = TheoreticalIndustries.Libraries.Messaging;

namespace CS555.HomeworkForm
{
	public partial class Form1 : Form, IFilterCallback
	{
		...
		private List<string> blackList = new List<string>(new string[]
				{
				"TheoreticalIndustries.Libraries.Messaging.dll",
				"TheoreticalIndustries.Libraries.Parsing.dll",
				"TheoreticalIndustries.Libraries.Starlight.dll",
				"TheoreticalIndustries.Libraries.Extensions.dll",
				"TheoreticalIndustries.Libraries.LexicalAnalysis.dll",
				"TheoreticalIndustries.Libraries.Tycho.dll",
				"TheoreticalIndustries.Libraries.Imaging.dll",
				"TheoreticalIndustries.Libraries.Filter.dll",
				"TheoreticalIndustries.Frameworks.Plugin.dll",
				"TheoreticalIndustries.Libraries.Collections.dll",
				});
		public Form1()
		{
		...
		{
			Assembly full = Assembly.LoadFile(Path.GetFullPath("TheoreticalIndustries.Libraries.Filter.dll"));
			...
			container = (IPluginLoader)pluginDomain.CreateInstanceAndUnwrap(
					full.FullName, "TheoreticalIndustries.Libraries.Filter.Initiator",
